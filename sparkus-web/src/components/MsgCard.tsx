...
export default function MsgCard(props) {
  const { key, text, likeCount, postDate } = props;
  // const { id, sender, subject, snippet, date } = msg;
  // console.log('---------', props);
      ...
      <div className='content'>
        <div className='back'>
          <div className='back-content'>
            <small className='badge'>{likeCount}</small>
            <svg
              stroke='#ffffff'
            ...
            <strong>{text.substr(0, 3)}...</strong>
            <div className='description'>
              <p className='card-footer'>{dayjs(postDate).fromNow()}</p>
            </div>
          </div>
        </div>
        <div className='front'>
          ...
          <div className='front-content'>
            <small className='badge'>{likeCount}</small>
            <strong className='centered-text'>{text}</strong>
